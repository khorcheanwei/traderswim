...
export default function TradingStockReplaceOrder({ rowCopyTradingAccount, onClose }) {
    ...
    async function handleReplaceOrder() {
        try {
            ...
            const { data } = await axios.post("/copy_trading_account/replace_order/", { optionChainSymbol, optionChainInstruction, optionChainOrderType, optionChainQuantity, optionChainPrice })

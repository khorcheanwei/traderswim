...
export function SettingsPanel(row) {
  ...
  async function deleteAccount() {
    ...
    try {
      const accountName = row.cell.row.original.accountName;
  ...
  return (
    <div className="flex">
      ...
      <svg onClick={deleteAccount} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 mx-2 cursor-pointer">

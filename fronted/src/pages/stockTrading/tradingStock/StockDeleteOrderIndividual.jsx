...
const StockDeleteOrderIndividual = memo(
  ({ rowCopyTradingOrderIndividual, onClose }) => {
    ...
    let stockDescription =
      rowCopyTradingOrderIndividual.cell.row.original.stockDescription;
    ...
    async function handleDeleteOrderIndividual() {
      ...
      try {
        const response = await axios.delete(
          "/stock_copy_trading/cancel_order_individual/",
          {
            data: {
      ...
      <form>
        <div className="mb-4">
          <h1 className="block text-gray-700 text-lm font-bold mb-2">
            Stock Delete Order (Individual) - <b>{accountUsername}</b>
          </h1>
        </div>
        <div className="mb-4">
...
export default StockDeleteOrderIndividual;

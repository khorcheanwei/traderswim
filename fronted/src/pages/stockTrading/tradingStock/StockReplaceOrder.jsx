...
export default function StockReplaceOrder({ rowCopyTradingOrder, onClose }) {
  ...
  let rowStockInstruction =
    rowCopyTradingOrder.cell.row.original.stockInstruction;
  let rowStockPrice = rowCopyTradingOrder.cell.row.original.stockPrice ?? 0;
  let rowStockStopPrice =
    rowCopyTradingOrder.cell.row.original.stockStopPrice ?? 0;
  let rowStockStopPriceLinkType =
    rowCopyTradingOrder.cell.row.original.stockStopPriceLinkType ?? "VALUE";
  let rowStockStopPriceOffset =
    rowCopyTradingOrder.cell.row.original.stockStopPriceOffset ?? 0.1;
        ...
        <div>
          <div className="mb-4">
            <h1 className="block text-gray-700 text-lm font-bold mb-2">
              Stock Replace Order ( {copyTradingAllAccountData.length} accounts
              )
            </h1>
          </div>
          <StockHandleOrder

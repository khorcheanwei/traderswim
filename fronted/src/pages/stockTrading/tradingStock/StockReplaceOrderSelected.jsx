...
const StockReplaceOrderSelected = memo(({ rowCopyTradingOrderSelected, selectedOrderDict, onClose }) => {
    ...
    let rowStockSession = rowCopyTradingOrderSelected.cell.row.original.stockSession;
    let rowStockDuration = rowCopyTradingOrderSelected.cell.row.original.stockDuration;
    ...
    let rowStockPrice = rowCopyTradingOrderSelected.cell.row.original.stockPrice ?? 0;
    let rowStockStopPrice = rowCopyTradingOrderSelected.cell.row.original.stockStopPrice ?? 0;
    let rowStockStopPriceLinkType = rowCopyTradingOrderSelected.cell.row.original.stockStopPriceLinkType ?? "VALUE";
    let rowStockStopPriceOffset = rowCopyTradingOrderSelected.cell.row.original.stockStopPriceOffset ?? 0.1;

...
export function StockPlaceOrderPanel({ row }) {
  ...
  let place_order_class =
    "cursor-pointer inline-flex items-center justify-center w-10 h-10 rounded-full ";
  ...
  return (
    <div className="flex">
      <div
        ...
        className="cursor-pointer inline-flex items-center justify-center w-10 h-10 rounded-full bg-purple-600"
      >

...
export function SettingsPanel({row, setStockSaveOrderList}) {
  ...
  const stockSaveOrderDeleteClose = async () => {
    const {data} = await axios.delete("/stock_save_order/remove_stock_save_order/", { data:{ "stockSymbol": stockSymbol }});
  ...
  return (
    <div className="flex">
      <svg onClick={stockSaveOrderDeleteClose} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 mx-2 cursor-pointer">

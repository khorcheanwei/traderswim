...
export default function StockCopyTradingAllAccountPositionPage({
  ...
  const columns = React.useMemo(
    () => [
      ...
      },
      {
        ...
        Cell: (row) => (
          <MakeSelectedStockPositionPanel
            row={row}
  ...
  let stockCopyTradingPositionAllAccountData =
    stockCopyTradingPositionDataDict[stockSymbol];
  stockCopyTradingPositionAllAccountData.sort(
    (a, b) => a["stockSettledQuantity"] - b["stockSettledQuantity"],
  );

  var data = React.useMemo(
    () => stockCopyTradingPositionAllAccountData,
    [stockCopyTradingPositionAllAccountData],
  );

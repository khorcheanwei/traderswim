...
export function MakeSelectedStockPositionPanel({row, setSelectedPositionDict}) {
  ...
  const handleSelectedPositionChange = (event) => {
    ...
    setSelectedPositionDict((prevSelectedPositionDict) => {
      ...
      if (newSelectedPositionDict.hasOwnProperty(row.cell.row.original.accountUsername) && !event.target.checked) {

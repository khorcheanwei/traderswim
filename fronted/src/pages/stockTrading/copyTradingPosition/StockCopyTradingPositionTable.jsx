  ...
  return (
    <div className="flex">
      ...
      <Overlay isOpen={isOpenViewAllPosition}>
        <StockCopyTradingAllAccountPositionPage
...
export function ChangePositionPanel(row) {
  ...
  const { rowCopyTradingPosition, setRowCopyTradingPosition } = useContext(
    StockCopyTradingPositionContext,
  );
    ...
    <div className="flex">
      ...
      <Overlay isOpen={isOpenOrderExit}>
        <StockExitOrder
          ...
          setIsOpenOrderExit={setIsOpenOrderExit}
        ></StockExitOrder>
      </Overlay>
    </div>
  );
...
export function SettledQuantityColorChange(row) {
  ...
  return (
    <div>
      <span className={settledQuantityColorChange(stockSettledQuantity)}>
        {stockSettledQuantity}
      </span>
    </div>
  );
}

...
import {
  TextStockSymbolColorPanel,
  TextStockFilledQuantityColorPanel,
  TextStockPriceColorPanel,
  TextStockQuantityColorPanel,
  TextStockInstructionColorPanel,
  TextStockStatusColorPanel,
  TextStockOrderTypeColorPanel,
  TextStockEnteredTimeColorPanel,
  TextAccountNameColorPanel,
  TextAccountUsernameColorPanel,
  ChangeOrderIndividualPanel,
  MakeSelectedOrderPanel,
} from "./StockCopyTradingAllAccountOrderTable";

export default function StockCopyTradingAllAccountOrderPage({
  rowCopyTradingOrder,
  onClose,
}) {

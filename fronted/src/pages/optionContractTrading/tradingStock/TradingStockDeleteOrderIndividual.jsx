...
export default function TradingStockDeleteOrderIndividual({
  ...
  async function handleDeleteOrderIndividual() {
    ...
    try {
      const response = await axios.delete(
        "/copy_trading_account/cancel_order_individual/",
        {
          data: {
    ...
    <form>
      <div className="mb-4">
        <h1 className="block text-gray-700 text-lm font-bold mb-2">
          Option Delete Order (Individual) - <b>{accountUsername}</b>
        </h1>
      </div>
      <div className="mb-4">
        Are you sure to delete this order <b>{optionChainDescription}</b>?
      </div>

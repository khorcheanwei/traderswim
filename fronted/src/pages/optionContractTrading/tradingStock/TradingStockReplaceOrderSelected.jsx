...
export default function TradingStockReplaceOrderSelected({
  ...
  let optionChainOrderId =
    rowCopyTradingOrderSelected.cell.row.original.optionChainOrderId;
  let optionChainDescription =
    rowCopyTradingOrderSelected.cell.row.original.optionChainDescription;
  let rowOptionChainSymbol =
    rowCopyTradingOrderSelected.cell.row.original.optionChainSymbol;
  let rowOptionChainInstruction =
    rowCopyTradingOrderSelected.cell.row.original.optionChainInstruction;
  let rowOptionChainOrderType =
    rowCopyTradingOrderSelected.cell.row.original.optionChainOrderType;
  let rowOptionChainQuantity =
    rowCopyTradingOrderSelected.cell.row.original.optionChainQuantity;
  let rowOptionChainPrice =
    rowCopyTradingOrderSelected.cell.row.original.optionChainPrice;

...
export default function TradingStockReplaceOrder({
  rowCopyTradingOrder,
  onClose,
}) {
  ...
  let optionChainDescription =
    rowCopyTradingOrder.cell.row.original.optionChainDescription;
  let rowOptionChainSymbol =
    rowCopyTradingOrder.cell.row.original.optionChainSymbol;
  let rowOptionChainInstruction =
    rowCopyTradingOrder.cell.row.original.optionChainInstruction;
  let rowOptionChainOrderType =
    rowCopyTradingOrder.cell.row.original.optionChainOrderType;
  let rowOptionChainQuantity =
    rowCopyTradingOrder.cell.row.original.optionChainQuantity;
  let rowOptionChainPrice =
    rowCopyTradingOrder.cell.row.original.optionChainPrice;
    ...
    <div>
      <div className="mb-4">
        <h1 className="block text-gray-700 text-lm font-bold mb-2">
          Option Replace Order ( {copyTradingAllAccountData.length} accounts )
        </h1>
      </div>
      <div>

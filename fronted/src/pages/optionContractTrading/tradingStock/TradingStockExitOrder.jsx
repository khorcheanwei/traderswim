...
export default function TradingStockExitOrder({
  ...
  let optionChainDescription =
    rowCopyTradingPosition.cell.row.original.optionChainDescription;
  const copyTradingPositionAllAccountData =
    copyTradingPositionDataDict[optionChainDescription];

  let rowOptionChainSymbol =
    rowCopyTradingPosition.cell.row.original.optionChainSymbol;
  ...
  let rowOptionChainAveragePrice =
    rowCopyTradingPosition.cell.row.original.optionChainAveragePrice;
  ...
  async function handleExitOrder() {
    ...
    try {
      const allTradingAccountsOrderList = copyTradingPositionAllAccountData.map(
        (item) => ({

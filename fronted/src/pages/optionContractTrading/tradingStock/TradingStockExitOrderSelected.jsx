...
export default function TradingStockExitOrderSelected({ selectedPositionDict, onClose }) {
    ...
    let optionChainDescription = firstSelectedPosition.optionChainDescription;
    let rowOptionChainSymbol = firstSelectedPosition.optionChainSymbol;
    //let rowOptionChainInstruction =firstSelectedPosition.optionChainInstruction;
    //let rowOptionChainOrderType = firstSelectedPosition.optionChainOrderType;
    let rowOptionChainSettledQuantity = firstSelectedPosition.optionChainSettledQuantity;
    if (rowOptionChainSettledQuantity < 0) {
        rowOptionChainSettledQuantity = -rowOptionChainSettledQuantity;
    }
    let rowOptionChainAveragePrice = firstSelectedPosition.optionChainAveragePrice;

...
export default function TradingStockReplaceOrderIndividual({
  ...
  let optionChainOrderId =
    rowCopyTradingOrderIndividual.cell.row.original.optionChainOrderId;
  let optionChainDescription =
    rowCopyTradingOrderIndividual.cell.row.original.optionChainDescription;
  let rowOptionChainSymbol =
    rowCopyTradingOrderIndividual.cell.row.original.optionChainSymbol;
  let rowOptionChainInstruction =
    rowCopyTradingOrderIndividual.cell.row.original.optionChainInstruction;
  let rowOptionChainOrderType =
    rowCopyTradingOrderIndividual.cell.row.original.optionChainOrderType;
  let rowOptionChainQuantity =
    rowCopyTradingOrderIndividual.cell.row.original.optionChainQuantity;
  let rowOptionChainPrice =
    rowCopyTradingOrderIndividual.cell.row.original.optionChainPrice;
  ...
  async function handleReplaceOrderIndividual() {
    ...
    try {
      const { data } = await axios.put(
        "/copy_trading_account/replace_order_individual/",
        {
    ...
    <div>
      <div className="mb-4">
        <h1 className="block text-gray-700 text-lm font-bold mb-2">
          Option Replace Order (Individual) - <b>{accountUsername}</b>
        </h1>
      </div>
      <div>
